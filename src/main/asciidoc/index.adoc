...
include::{snippets}/v1/beer-all/curl-request.adoc[]

One showing the HTTP request:

include::{snippets}/v1/beer-all/http-request.adoc[]

And one showing the HTTP response:

include::{snippets}/v1/beer-all/http-response.adoc[]

Response Body:
include::{snippets}/v1/beer-all/response-body.adoc[]

Response Fields:
include::{snippets}/v1/beer-all/response-fields.adoc[]
